...
try:
    ...
    class _DummyPreview:
        ...
        def start(self): pass
        def stop(self): pass
    AMDContinuousHEVCPreview = _DummyPreview  # type: ignore[misc, assignment]
    AMDGPUNativeFrameTapPreview = _DummyPreview  # type: ignore[misc, assignment]
...
class RenderTab(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        try:
            ...
            nv_native_ok, nv_native_reason = False, "Brak modułu NVIDIA"
