...
out_mp4 = root / "scratch" / "benchmark_etap10o_amd.mp4"
if out_mp4.exists():
    out_mp4.unlink()
...
print("=" * 70)
print("Starting Official AMD Production Benchmark (ETAP 10O, 120 frames @ 60 FPS, 1280x720)...")
print("=" * 70)
...
print(f"AMD Benchmark finished in {wall_elapsed:.3f} s.")
