"""Save composed_img for frame 0 and frame 30 to PNG."""
import json
import sys
...
for frame_idx in (0, 30):
    ...
    composed_img.save(root / "scratch" / f"dump_composed_img_{frame_idx}.png")
    print(f"Saved scratch/dump_composed_img_{frame_idx}.png with bboxes={_bboxes}")
