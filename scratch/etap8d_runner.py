"""ETAP 8D runner for 900-frame baseline and comparative runs on GX030120.MP4."""
...
parser.add_argument("--above-mode", choices=("default", "empty"), default="default")
parser.add_argument("--frames", type=int, default=900)
parser.add_argument("--profile", action="store_true", help="Enable AMD_OVERLAY_PROFILE=1")
...
os.environ.update({
    ...
    "AMD_OVERLAY_PROFILE": "1" if args.profile else "0",
})
...
if args.above_mode == "empty":
    # Disable indicators after track_map in runtime copy
    before_map = True
...
out = root / "Raporty" / "AMD_ETAP8D" / f"{args.tag}.mp4"
out.parent.mkdir(parents=True, exist_ok=True)

duration = args.frames * (1001 / 30000)
...
print(f"ETAP8D {args.tag} above_mode={args.above_mode} frames={args.frames} result={result}")
