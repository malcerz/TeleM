...
out_mp4 = root / "scratch" / "smoke_10m2_amd.mp4"
if out_mp4.exists():
    out_mp4.unlink()
...
print("=" * 70)
print("Starting AMD Native Smoke Test (ETAP 10M2, 60 frames @ 60 FPS, 1280x720)...")
print("=" * 70)
...
print(f"AMD Smoke finished in {wall_elapsed:.3f} s.")
