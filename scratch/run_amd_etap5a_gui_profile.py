"""Reproduce the real GUI AMD export call for ETAP 5A profiling."""
...
def main() -> int:
    ...
    parser.add_argument(
        "--output",
        default="Raporty/AMD_ETAP5A/full_gui_profile_1131.mp4",
    )
    ...
    # Same start timestamp and local-time offset used by the validated ETAP 4
    # production GUI run.
