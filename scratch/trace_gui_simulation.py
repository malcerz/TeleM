"""Simulate GUI loading and trace why indicators are missing."""
import json
import sys
...
def simulate_gui():
    ...
    # Instantiate TelemetryDataManager exactly like Controller
    ...
    print(f"Loaded records count: {len(records)}")
    ...
    # Let's test prepare_overlay_frame_data at ts=0
    ...
    print("Extra indicators:")
    for k, v in frame_data.get("extra_indicators", {}).items():
        print(f"  {k}: {v}")
    ...
    print("\nRendered bboxes in compose_overlay:")
